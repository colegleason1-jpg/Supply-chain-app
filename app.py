...
# Reset index to flatten MultiIndex and prevent StreamlitAPIException, updated with width="stretch"
df_for_editor = st.session_state.nodes_df.reset_index(drop=True)

edited_nodes = st.sidebar.data_editor(
    df_for_editor, num_rows="dynamic", width="stretch", key="nodes_data_editor"
)
