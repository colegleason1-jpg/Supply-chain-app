...
# Expandable description detailing AI capabilities
...
# File Uploader Widget supporting Excel and CSV formats
...
# Handle dynamic file ingestion safely when uploaded
...
# --- UNTOUCHED MASTER HYBRID OPTIMIZATION ENGINE: PULP ---
bundle_vars = {}
if enable_target_mode:
...
# --- MASTER AI EXPERT COPILOT WRAPPER ---
with st.sidebar:
    st.markdown("---")
